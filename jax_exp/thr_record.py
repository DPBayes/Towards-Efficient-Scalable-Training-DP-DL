...
if __name__ == '__main__':
    ...
    row = [args.model,args.clipping_mode,args.normalization,args.epochs,args.phy_bs,err,thr,t_th,acc,comp_time,args.epsilon]
    ...
    with open(path_log, mode="a") as f:    
        ...
        if not exists:
            writer.writerow(["model", "clipping_mode","normalization","epochs", "physical_batch", "fail",'throughput','total_throughput','acc_test','compilation_time','epsilon'])
